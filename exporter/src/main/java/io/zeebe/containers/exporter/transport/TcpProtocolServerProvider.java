...
final class TcpProtocolServerProvider implements ProtocolServer.Provider {

  @NonNull
  @Override
  public ProtocolServer provideProtocolServer(
    ...
    return new TcpProtocolServer(
        name, transferQueue, controller, config.getMaxResponseBatchSize(), logger);
  }
}
